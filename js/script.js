...
// Function to save recipes to the API
async function saveRecipesToAPI(recipes) {
    const url = `${API_BASE_URL}your-save-recipes-endpoint`; // Replace with actual endpoint
    const options = {
        method: 'POST',
        headers: {
    ...
    console.log('Recipes saved to API.');
}

// Function to load recipes from the API
async function loadRecipesFromAPI() {
    const url = `${API_BASE_URL}your-load-recipes-endpoint`; // Replace with actual endpoint
    const options = {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
...
// Example API usage: Search meal by name
async function searchMealByName(mealName) {
    const url = `${API_BASE_URL}search.php?s=${mealName}`;
    const data = await fetchData(url);
    // Handle the data, such as displaying it on the webpage
    console.log('Search result:', data);
}

// Example API usage: Lookup full meal details by ID
async function lookupMealById(mealId) {
    const url = `${API_BASE_URL}lookup.php?i=${mealId}`;
    const data = await fetchData(url);
    // Handle the data, such as displaying it on the webpage
